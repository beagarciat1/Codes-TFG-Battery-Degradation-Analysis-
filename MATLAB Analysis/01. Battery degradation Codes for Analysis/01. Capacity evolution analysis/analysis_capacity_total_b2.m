function Q_loss_real = analysis_capacity_total_b2()
% =========================================================
% analysis_capacity_total_b2.m
%
...
%   [Q_loss_real] = analysis_capacity_total_b2();
...
% ====================================================================
raw_c = readmatrix(archivo, 'Sheet', 'Hoja1', 'Range', 'B2:C500', 'UseExcel', false);
raw_d = readmatrix(archivo, 'Sheet', 'Hoja2', 'Range', 'B2:C500', 'UseExcel', false);
