...
% analysis_capacity_total_b2 (MEDIA_EXP_BATERIA1_25.xlsx), que
...
% Se lee directamente del Excel generado por analysis_capacity_total_b2
...
if ~isfile(ruta_media)
    fprintf('[INFO] Excel no encontrado. Ejecutando analysis_capacity_total_b2...\n');
    % Forzar la versión correcta (Batería 1)
    addpath('C:\your_route\your_folder', '-begin');
    analysis_capacity_total_b2();
end
